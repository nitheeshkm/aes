...
assign buff0 =  data_i[31] ? {data_i[30:24],1'b0} ^ 8'h1b ^ data_i[31:24] : {data_i[30:24],1'b0} ^ data_i[31:24];
assign buff1 =  data_i[23:16];
assign buff2 =  data_i[15:8];
assign buff3 =  data_i[7] ? {data_i[6:0], 1'b0} ^ 8'h1b : {data_i[6:0], 1'b0};

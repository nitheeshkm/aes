...
assign buff1 = data_i[23] ? {data_i[22:16], 1'b0} ^ 8'h1b  : {data_i[22:16], 1'b0};
assign buff2 = data_i[15] ? {data_i[14:8],1'b0} ^ 8'h1b ^ data_i[15:8] : {data_i[14:8],1'b0} ^ data_i[15:8] ;
assign buff3 =  data_i[7:0];
